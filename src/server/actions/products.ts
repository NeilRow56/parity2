...
import { z } from "zod"
import { createProduct as createProductDb,  deleteProduct as deleteProductDb, updateProduct as updateProductDb,} from "@/server/db/product";
...
export async function createProduct(
  ...
  redirect(`products/${id}/edit?tab=countries`)
}
